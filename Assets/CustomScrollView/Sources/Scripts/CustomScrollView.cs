...
{
    public abstract class CustomScrollView<TItemData, TContext> : MonoBehaviour where TContext : class, new()
    {
        ...
        readonly IList<Cell<TItemData, TContext>> pool = new List<Cell<TItemData, TContext>>();
    ...
    public abstract class CustomScrollView<TItemData> : CustomScrollView<TItemData, NullContext> { }
}
